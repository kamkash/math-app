# Yet another intelligent symbolic math calculator application
## Planned features:
    ...
    4. antlr grammar based parser generator and evaluator for math and LaTex
    5. Create symengine-rs Rust bindings for C++ symengine
    6. Create GiNaC-rs Rust bindings for C++ GiNaC
