 ...
 * @param ctx the parse tree
 */
fn enter_appliedDByDxPrefix(&mut self, _ctx: &AppliedDByDxPrefixContext<'input>) { }
/**
 * Exit a parse tree produced by the {@code appliedDByDxPrefix}
 * labeled alternative in {@link AsciiMath2Parser#unary_op_expression}.
 * @param ctx the parse tree
 */
fn exit_appliedDByDxPrefix(&mut self, _ctx: &AppliedDByDxPrefixContext<'input>) { }
/**
...
/**
 * Enter a parse tree produced by {@link AsciiMath2Parser#d_dx_function}.
 * @param ctx the parse tree
 */
fn enter_d_dx_function(&mut self, _ctx: &D_dx_functionContext<'input>) { }
/**
 * Exit a parse tree produced by {@link AsciiMath2Parser#d_dx_function}.
 * @param ctx the parse tree
 */
fn exit_d_dx_function(&mut self, _ctx: &D_dx_functionContext<'input>) { }
/**
 * Enter a parse tree produced by {@link AsciiMath2Parser#d_dx_prefix_operator}.
 * @param ctx the parse tree
 */
fn enter_d_dx_prefix_operator(&mut self, _ctx: &D_dx_prefix_operatorContext<'input>) { }
/**
 * Exit a parse tree produced by {@link AsciiMath2Parser#d_dx_prefix_operator}.
 * @param ctx the parse tree
 */
fn exit_d_dx_prefix_operator(&mut self, _ctx: &D_dx_prefix_operatorContext<'input>) { }
/**
