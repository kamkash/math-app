...
use std::any::{Any,TypeId};
		...
		pub const UNDERSCORE:isize=80; 
		pub const PRIME:isize=81; 
		pub const BANG:isize=82; 
		pub const EQ:isize=83; 
		pub const DOUBLE_EQ:isize=84; 
		pub const NEQ:isize=85; 
		pub const LT:isize=86; 
		pub const GT:isize=87; 
		pub const LTE:isize=88; 
		pub const GTE:isize=89; 
		pub const TO:isize=90; 
		pub const RARROW:isize=91; 
		pub const LARROW:isize=92; 
		pub const PM:isize=93; 
		pub const TIMES:isize=94; 
		pub const DIV:isize=95; 
		pub const AND:isize=96; 
		pub const OR:isize=97; 
		pub const NOT:isize=98; 
		pub const LPAREN:isize=99; 
		pub const RPAREN:isize=100; 
		pub const LBRACKET:isize=101; 
		pub const RBRACKET:isize=102; 
		pub const LBRACE:isize=103; 
		pub const RBRACE:isize=104; 
		pub const ABS:isize=105; 
		pub const L_ANGLE:isize=106; 
		pub const R_ANGLE:isize=107; 
		pub const COMMA:isize=108; 
		pub const SEMICOLON:isize=109; 
		pub const ALPHA_G:isize=110; 
		pub const BETA_G:isize=111; 
		pub const DELTA_G:isize=112; 
		pub const EPSILON_G:isize=113; 
		pub const ZETA_G:isize=114; 
		pub const ETA_G:isize=115; 
		pub const THETA_G:isize=116; 
		pub const IOTA_G:isize=117; 
		pub const KAPPA_G:isize=118; 
		pub const LAMBDA_G:isize=119; 
		pub const MU_G:isize=120; 
		pub const NU_G:isize=121; 
		pub const XI_G:isize=122; 
		pub const RHO_G:isize=123; 
		pub const SIGMA_G:isize=124; 
		pub const TAU_G:isize=125; 
		pub const UPSILON_G:isize=126; 
		pub const CHI_G:isize=127; 
		pub const PSI_G:isize=128; 
		pub const OMEGA_G:isize=129; 
		pub const GREEK_LETTER:isize=130; 
		pub const IDENTIFIER:isize=131; 
		pub const LOWERCASE_LETTER:isize=132; 
		pub const NUMBER:isize=133; 
		pub const NUMBER_WITH_COMMAS:isize=134; 
		pub const CURRENCY_NUMBER:isize=135; 
		pub const SCIENTIFIC_NUMBER:isize=136; 
		pub const STRING:isize=137; 
		pub const SEPARATOR:isize=138; 
		pub const WS:isize=139;
	...
	pub const RULE_keyword_func:usize = 21; 
	pub const RULE_simple_keyword_func:usize = 22; 
	...
	pub const ruleNames: [&'static str; 32] =  [
		...
		"add_sub_expression", "mult_div_implicit_expression", "power_expression", 
		"unary_op_expression", "differential", "integral_body", "integral_upper_limit", 
		"integral_lower_limit", "script_op_expression", "primary_expression", 
		"paren_element_for_column_vector", "arguments", "text_argument", "wrt_argument", 
		"matrix_content", "matrix_row", "keyword_func", "simple_keyword_func", 
		"deriv_function", "d_by_d", "derivative", "partial_derivative", "function_call", 
		"constant_symbol", "relop", "sumop", "multop"
	];
	...
	pub const _LITERAL_NAMES: [Option<&'static str>;130] = [
		...
		None, None, Some("'to'"), None, None, None, None, None, Some("'and'"), 
	...
	pub const _SYMBOLIC_NAMES: [Option<&'static str>;140]  = [
		...
		Some("PRIME"), Some("BANG"), Some("EQ"), Some("DOUBLE_EQ"), Some("NEQ"), 
		Some("LT"), Some("GT"), Some("LTE"), Some("GTE"), Some("TO"), Some("RARROW"), 
		Some("LARROW"), Some("PM"), Some("TIMES"), Some("DIV"), Some("AND"), Some("OR"), 
		Some("NOT"), Some("LPAREN"), Some("RPAREN"), Some("LBRACKET"), Some("RBRACKET"), 
		Some("LBRACE"), Some("RBRACE"), Some("ABS"), Some("L_ANGLE"), Some("R_ANGLE"), 
		Some("COMMA"), Some("SEMICOLON"), Some("ALPHA_G"), Some("BETA_G"), Some("DELTA_G"), 
		Some("EPSILON_G"), Some("ZETA_G"), Some("ETA_G"), Some("THETA_G"), Some("IOTA_G"), 
		Some("KAPPA_G"), Some("LAMBDA_G"), Some("MU_G"), Some("NU_G"), Some("XI_G"), 
		Some("RHO_G"), Some("SIGMA_G"), Some("TAU_G"), Some("UPSILON_G"), Some("CHI_G"), 
		Some("PSI_G"), Some("OMEGA_G"), Some("GREEK_LETTER"), Some("IDENTIFIER"), 
		Some("LOWERCASE_LETTER"), Some("NUMBER"), Some("NUMBER_WITH_COMMAS"), 
...
fn sumop_all(&self) ->  Vec<Rc<SumopContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sumop(&self, i: usize) -> Option<Rc<SumopContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
fn power_expression_all(&self) ->  Vec<Rc<Power_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn power_expression(&self, i: usize) -> Option<Rc<Power_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn multop_all(&self) ->  Vec<Rc<MultopContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn multop(&self, i: usize) -> Option<Rc<MultopContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
//------------------- power_expression ----------------
pub type Power_expressionContextAll<'input> = Power_expressionContext<'input>;


pub type Power_expressionContext<'input> = BaseParserRuleContext<'input,Power_expressionContextExt<'input>>;

#[derive(Clone)]
pub struct Power_expressionContextExt<'input>{
ph:PhantomData<&'input str>
}

impl<'input> AsciiMath2ParserContext<'input> for Power_expressionContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for Power_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
			listener.enter_power_expression(self);
		}
		fn exit(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.exit_power_expression(self);
			listener.exit_every_rule(self);
		}
}

impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for Power_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
		visitor.visit_power_expression(self);
	}
}

impl<'input> CustomRuleContext<'input> for Power_expressionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = AsciiMath2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_power_expression }
	//fn type_rule_index() -> usize where Self: Sized { RULE_power_expression }
}
antlr_rust::tid!{Power_expressionContextExt<'a>}

impl<'input> Power_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Power_expressionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Power_expressionContextExt{
				ph:PhantomData
			}),
		)
	}
...
fn unary_op_expression(&self) -> Option<Rc<Unary_op_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> Power_expressionContextAttrs<'input> for Power_expressionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn power_expression(&mut self,)
	-> Result<Rc<Power_expressionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Power_expressionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 14, RULE_power_expression);
        let mut _localctx: Rc<Power_expressionContextAll> = _localctx;
		let result: Result<(), ANTLRError> = (|| {
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Unary_op_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 16, RULE_unary_op_expression);
...
fn mult_div_implicit_expression(&self) -> Option<Rc<Mult_div_implicit_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
pub type Integral_upper_limitContextAll<'input> = Integral_upper_limitContext<'input>;


pub type Integral_upper_limitContext<'input> = BaseParserRuleContext<'input,Integral_upper_limitContextExt<'input>>;

#[derive(Clone)]
pub struct Integral_upper_limitContextExt<'input>{
ph:PhantomData<&'input str>
}

impl<'input> AsciiMath2ParserContext<'input> for Integral_upper_limitContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for Integral_upper_limitContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
			listener.enter_integral_upper_limit(self);
		}
		fn exit(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.exit_integral_upper_limit(self);
			listener.exit_every_rule(self);
		}
}

impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for Integral_upper_limitContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
		visitor.visit_integral_upper_limit(self);
	}
}

impl<'input> CustomRuleContext<'input> for Integral_upper_limitContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = AsciiMath2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_integral_upper_limit }
	//fn type_rule_index() -> usize where Self: Sized { RULE_integral_upper_limit }
}
antlr_rust::tid!{Integral_upper_limitContextExt<'a>}

impl<'input> Integral_upper_limitContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Integral_upper_limitContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Integral_upper_limitContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Integral_upper_limitContextAttrs<'input>: AsciiMath2ParserContext<'input> + BorrowMut<Integral_upper_limitContextExt<'input>>{
...
impl<'input> Integral_upper_limitContextAttrs<'input> for Integral_upper_limitContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn integral_upper_limit(&mut self,)
	-> Result<Rc<Integral_upper_limitContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Integral_lower_limitContextAll<'input> = Integral_lower_limitContext<'input>;


pub type Integral_lower_limitContext<'input> = BaseParserRuleContext<'input,Integral_lower_limitContextExt<'input>>;

#[derive(Clone)]
pub struct Integral_lower_limitContextExt<'input>{
ph:PhantomData<&'input str>
}

impl<'input> AsciiMath2ParserContext<'input> for Integral_lower_limitContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for Integral_lower_limitContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
			listener.enter_integral_lower_limit(self);
		}
		fn exit(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.exit_integral_lower_limit(self);
			listener.exit_every_rule(self);
		}
}

impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for Integral_lower_limitContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
		visitor.visit_integral_lower_limit(self);
	}
}

impl<'input> CustomRuleContext<'input> for Integral_lower_limitContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = AsciiMath2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_integral_lower_limit }
	//fn type_rule_index() -> usize where Self: Sized { RULE_integral_lower_limit }
}
antlr_rust::tid!{Integral_lower_limitContextExt<'a>}

impl<'input> Integral_lower_limitContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Integral_lower_limitContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Integral_lower_limitContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Integral_lower_limitContextAttrs<'input>: AsciiMath2ParserContext<'input> + BorrowMut<Integral_lower_limitContextExt<'input>>{
...
impl<'input> Integral_lower_limitContextAttrs<'input> for Integral_lower_limitContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn integral_lower_limit(&mut self,)
	-> Result<Rc<Integral_lower_limitContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Keyword_funcContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 42, RULE_keyword_func);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Simple_keyword_funcContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 44, RULE_simple_keyword_func);
...
impl<'input> AsciiMath2ParserContext<'input> for RelopContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for RelopContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for RelopContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
...
impl<'input> RelopContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<RelopContextAll<'input>> {
		Rc::new(
...
pub trait RelopContextAttrs<'input>: AsciiMath2ParserContext<'input> + BorrowMut<RelopContextExt<'input>>{
...
fn DOUBLE_EQ(&self) -> Option<Rc<TerminalNode<'input,AsciiMath2ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<RelopContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 83)) & !0x3f) == 0 && ((1usize << (_la - 83)) & ((1usize << (EQ - 83)) | (1usize << (DOUBLE_EQ - 83)) | (1usize << (NEQ - 83)) | (1usize << (LT - 83)) | (1usize << (GT - 83)) | (1usize << (LTE - 83)) | (1usize << (GTE - 83)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> AsciiMath2ParserContext<'input> for SumopContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for SumopContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for SumopContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
...
impl<'input> SumopContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SumopContextAll<'input>> {
		Rc::new(
...
pub trait SumopContextAttrs<'input>: AsciiMath2ParserContext<'input> + BorrowMut<SumopContextExt<'input>>{
...
/// Retrieves first TerminalNode corresponding to token PM
/// Returns `None` if there is no child corresponding to token PM
fn PM(&self) -> Option<Rc<TerminalNode<'input,AsciiMath2ParserContextType>>> where Self:Sized{
	self.get_token(PM, 0)
}
...
impl<'input> AsciiMath2ParserContext<'input> for MultopContext<'input>{}

impl<'input,'a> Listenable<dyn AsciiMath2Listener<'input> + 'a> for MultopContext<'input>{
		fn enter(&self,listener: &mut (dyn AsciiMath2Listener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn AsciiMath2Visitor<'input> + 'a> for MultopContext<'input>{
	fn accept(&self,visitor: &mut (dyn AsciiMath2Visitor<'input> + 'a)) {
...
impl<'input> MultopContextExt<'input>{
	fn new(parent: Option<Rc<dyn AsciiMath2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<MultopContextAll<'input>> {
		Rc::new(
...
pub trait MultopContextAttrs<'input>: AsciiMath2ParserContext<'input> + BorrowMut<MultopContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token STAR
/// Returns `None` if there is no child corresponding to token STAR
fn STAR(&self) -> Option<Rc<TerminalNode<'input,AsciiMath2ParserContextType>>> where Self:Sized{
...
fn TIMES(&self) -> Option<Rc<TerminalNode<'input,AsciiMath2ParserContextType>>> where Self:Sized{
...
fn DIV(&self) -> Option<Rc<TerminalNode<'input,AsciiMath2ParserContextType>>> where Self:Sized{
...
const _serializedATN:&'static str =
	...
	\u{8d}\u{15c}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\
	...
	\x20\x04\x21\x09\x21\x03\x02\x03\x02\x03\x02\x07\x02\x46\x0a\x02\x0c\x02\
	\x0e\x02\x49\x0b\x02\x03\x02\x07\x02\x4c\x0a\x02\x0c\x02\x0e\x02\x4f\x0b\
	\x02\x03\x02\x03\x02\x03\x03\x03\x03\x03\