...
class MathSolver extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (this.promptInputEl) {
      // this.promptInputEl.defaultMode = 'inline-math';
      // this.promptInputEl.mode = "math";
      // this.promptInputEl.mode = "text";
      this.promptInputEl.smartMode = true;
      // this.promptInputEl.smartFence = true; // auto \left...\right where appropriate
      // this.promptInputEl.executeCommand(['switchMode', 'math']); // switch to display math
      // this.promptInputEl.smartSuperscript = true; // disable auto-leap from superscript
    }
